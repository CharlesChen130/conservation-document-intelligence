...
- Ramsar's wise-use guidance includes adoption of national wetland policies, development of wetland inventory and monitoring programs, and integrated management plans for wetlands and their catchments. [DOC027, pp. 47-49]
- The department will participate in, and facilitate, the review and approval of wetland mitigation banking and in-lieu fee program instruments; including, review and approval of new wetland mitigation plans for each additional site once instrument is established. [DOC002, pp. 10-13]
- Urban planning efforts to restore and conserve wetlands. [DOC002, pp. 6-8]
...
- The EPA and the U.S. Army Corps of Engineers jointly administer a permit program to regulate discharges of dredged or fill materials into waters, including wetlands, of the United States under the Clean Water Act. [DOC031, pp. 12-14]
- The EPA provides technical support and funding through Wetland Program Development Grants to states, tribes, and local governments to develop or refine wetland programs which protect, manage, and restore wetlands. [DOC023]
...
- **Ramsar Resources** — The Integrated Framework for wetland inventory, monitoring, and assessment adopted by Resolution IX.1 (2005; Handbook 13) noted that “the delivery of the conservation and wise use of wetlands, in line with the commitments embodied in the Ramsar Convention, entails: a) establishing the location and ecological characteristics of wetlands (baseline inventory); b) assessing the status, trends and threats to wetlands (assessment); c) monitoring the status and trends [DOC027, pp. 50-52]
...
- The USGS Nonindigenous Aquatic Species (NAS) database provides real-time updated occurrence records and distribution maps that help agencies detect nonindigenous aquatic species. [DOC011, pp. 4-6]
- USACE promotes and utilizes the USGS NAS Alert System and disseminates existing databases to improve detection and identification of invasive species and implement management actions. [DOC006, pp. 13-15]
- The DOI bureaus share data with national invasive species databases including the Nonindigenous Aquatic Species Database to support invasive species management. [DOC007, pp. 22-24]
- The NAS database and related tools provide maps and data that help assess impacts and support rapid response planning for invasive aquatic species. [DOC007, pp. 22-24]
...
- The USGS advances understanding of natural aggregations of invasive carp using acoustic methods of locating fish and studying their relations to habitat variables such as water temperature, velocity, and food availability. [DOC012, pp. 17-20]
- Food attractants have been the most successful stimuli for attracting invasive carp, with pheromone attractants also under investigation. [DOC012, pp. 17-20]
- Removal efforts focus on increasing efficiency of removal gears and exploiting natural or artificial aggregations of bigheaded carp to increase removal. [DOC012, pp. 17-20]
...
- Missouri's State Wildlife Action Plan focuses on identifying and prioritizing areas with the greatest opportunity for conservation of the state's full suite of fish and wildlife diversity, emphasizing a habitat-based approach. [DOC001, pp. 27-29]
...
- Missouri Wetland Program Plan explores opportunities to modify wetland infrastructure for flood resiliency and support partner efforts to restore stream-floodplain-watershed system functions that lessen localized flood damage to communities, homes, farms, and other infrastructure. [DOC002, pp. 15-17]
- Canada's wetlands provide natural flood control, water cleansing, and groundwater recharge benefits to Canadians. [DOC034, pp. 95-97]
...
- One of the Plan’s greatest strengths is the ability of its partners to quickly pool and leverage conservation funding from a variety of sources, expanding the Plan’s conservation reach and supporting strategically targeted local, regional, and international habitat conservation projects. [DOC004, pp. 1-3]
- The Canadian Habitat Joint Ventures integrate planning, science, governance, partnerships and management to achieve the NAWMP goals in Canada through a programmatic approach, creating science-based Implementation Plans to address local, regional and continental goals. [DOC014, pp. 8-10]
...
- ANSTF should convene federal, state, regional, and tribal agencies to launch coordinated and science-based public education and outreach campaigns on AIS prevention, leaning on trusted and influential voices within recreational fishing and boating communities, the hunting community, and other relevant communities. [DOC009, pp. 12-15]
