...
- **Invasive Species Accomplishments Report PDF** — Invasive Species Accomplishments Report describes integrated management strategies including monitoring, containment, control, research, and education for zebra mussels [DOC008, pp. 16-22]
...
- The Missouri CCS was approved in February 2022. [DOC018]
...
- The Missouri State Wildlife Action Plan recognizes climate change as a major threat and incorporates climate change considerations into forest management and conservation planning. [DOC001, pp. 30-31]
...
- The U.S. Geological Survey (USGS) Nonindigenous Aquatic Species Database tracks introductions of freshwater aquatic organisms in the United States and provides occurrence reports, distribution maps, and fact sheets to support natural resource managers. [DOC011, pp. 1-2]
- USGS research also supports efforts of Federal management partners, such as the invasive carp subbasin partnerships. [DOC012, pp. 11-12]
- USACE implements an Invasive Species Program consistent with national invasive species management plans, with an Invasive Species Leadership Team providing strategic direction and coordination across the agency. [DOC006, pp. 11-13]
- USACE spends significant annual funding on invasive species control, management, prevention, early detection, rapid response, restoration, leadership, coordination, education, outreach, and research. [DOC006, pp. 1-3]
...
- USFWS National Wetlands Inventory produces maps and geospatial data on wetland habitats and monitors changes over time to support decision makers. [DOC022]
- Missouri Wetland Program Plan includes monitoring and assessment strategies to provide state resource managers with information to conserve and promote wetland resources. [DOC002, pp. 3-6]
- Ramsar Resources states that inventory, assessment, and monitoring activities help acquire knowledge necessary to manage wetlands effectively. [DOC027, pp. 49-50]
- Ramsar Resources explains that monitoring measures change in wetland ecological character over time to inform management actions. [DOC027, pp. 50-52]
- USFWS National Wetlands Inventory Status and Trends reports inform decision-makers on wetland status and potential causes and implications of change. [DOC022]
...
- Fall Flights is a powerful partnership program coordinated by the Association of Fish & Wildlife Agencies (A F W A). It unites state fish and wildlife agencies to conserve critical breeding habitats in Canada. [DOC014, pp. 7-8]
...
- The North Dakota wildlife action plan identifies 100 species in need of conservation including birds, mammals, reptiles, amphibians, fish and freshwater mussels. [DOC013, pp. 13-15]
...
- Missouri State Wildlife Action Plan combines prescribed burning and grazing to restore and maintain diversity and vegetative structure of healthy grassland communities. [DOC001, pp. 61-63]
- MDC Annual Review FY2024 reports focused work in Golden Grasslands priority geography is resulting in improved native grasslands and livestock forage on public and private working lands. [DOC016]
...
- During 2021, the partnership removed a total of 9,857 feral hogs from Missouri’s landscape. [DOC018]
- Also in 2021, four feral hog outreach specialists were hired as part of the University of Missouri’s Extension Program to act as liaisons for the partnership. [DOC018]
- During 2023, the partnership removed 7,885 hogs from the landscape, assisted 660 landowners, and scouted more than 3.8 million acres. In addition to on-the-ground operations, the partnership placed equipment at Soil and Water Conservation District offices for landowners to use in areas with high feral hog activity; distributed mail-out landowner surveys to collect information regarding feral hog damage, mitigation, and removal efforts; and conducted landowner and community outreach activities. [DOC016]
...
- These voluntary designs standards could include aspects that alter and/or improve the design, engineering and manufacturing of ballast tanks, inboard engines, inboard/outboard engines, and new watercraft to eliminate or reduce the probability of quagga or zebra mussels and other AIS from being transported in recreational watercraft. [DOC009, pp. 11-12]
- Aquatic Invasive Species in the Chesapeake Bay Watershed document states AIS are introduced via ballast water of large ships and biofouling of boat hulls, among other transport pathways. [DOC005, pp. 14-15]
...
- Missouri Wetland Program Plan states wetlands provide flood water retention, water quality improvement, sediment retention, and wildlife habitat. [DOC002, pp. 1-3]
- Ramsar Resources describes wetlands performing water storage, flood mitigation, water purification, and retention of nutrients, sediments, and pollutants. [DOC027, pp. 10-12]
- Missouri State Wildlife Action Plan notes wetland restoration improves water quality, lessens flood damage, and provides habitat for wetland-dependent species. [DOC001, pp. 140-145]
- NAWMP Value Proposition states wetlands help remove bacteria, phosphorous, and nitrates, contribute to drinking water quality, and reduce potential for damaging floods while providing critical wildlife habitat. [DOC004, pp. 1-3]
...
- Removal is currently the primary method used by resource managers to address existing populations of invasive carp, and removal efforts have focused on the highly abundant bigheaded carp. Increases in bigheaded carp removal can be achieved by increasing efficiency of removal gears, by understanding and taking advantage of natural or preexisting aggregations of carp, or by removing artificially aggregated carp. [DOC012, pp. 17-20]
- Invasive Carp Strategic Science Plan details early detection and surveillance tools including eDNA and integration into streamgage networks with automated sampling and analysis equipment. [DOC012, pp. 17-20]
- Invasive Carp Strategic Science Plan highlights deterrents such as sound-based and carbon dioxide deterrents to reduce risk of new invasions and expansions, with research on their effectiveness and impacts on native species. [DOC012, pp. 22-24]
- Aquatic Invasive Species Research Report describes electric dispersal barriers operated by USACE in the Chicago Sanitary and Ship Canal to prevent invasive carp movement between Mississippi River and Great Lakes basins. [DOC006, pp. 3-4]
...
- MDC Conservation Resources uses conservation easements through partnerships with the Missouri Prairie Foundation and others to permanently protect sensitive habitats critical for SGCN conservation. [DOC020, pp. 80-82]
- Through the use of cooperative agreements and memorandums of understanding, the Department is able to engage in cost-share opportunities with partners and private citizens. Examples of these partnership agreements include providing cost-share to the Missouri Prairie Foundation (MPF) for grassland restoration and maintenance, exotic and woody species control,public outreach, as well as providing cost-share to the Missouri River Bird Observatory (MRBO) for outreach and continued effectiveness. [DOC001, pp. 36-37]
...
- **USFWS National Wetlands Inventory** — The Service is responsible for producing and maintaining the Wetlands Layer of the National Spatial Data Infrastructure (NSDI), which is an important component of the DOI geospatial portfolio and identified as a National Geospatial Data Asset (NGDA) by the FGDC [DOC022]
