...
- **Invasive Species Accomplishments Report** — Aquatic Invasive Species Commission Report recommends funding for watercraft inspection and decontamination to control zebra mussels [DOC007, pp. 16-22]
- **Invasive Species Accomplishments Report PDF** — Invasive Species Accomplishments Report describes integrated management strategies including monitoring, containment, control, research, and education for zebra/quagga mussels [DOC008, pp. 16-22]
...
- The U.S. Geological Survey (USGS) manages the Nonindigenous Aquatic Species Database, tracking introduced aquatic species in the United States for over thirty years. [DOC011, pp. 1-2]
...
- Section 1108(a) of WRDA 2018, directs the Secretary to undertake research on the management and eradication of aquatic invasive species, including Asian carp and zebra mussels as part of the ongoing activities of the ERDC. [DOC006, pp. 1-3]
- In 2005, USACE established an Invasive Species Leadership Team (ISLT) to provide oversight of a comprehensive Invasive Species Program. The ISLT. [DOC006, pp. 11-13]
...
- Ramsar Resources states that inventory, assessment, and monitoring activities help acquire adequate knowledge of wetlands to manage them effectively. [DOC027, pp. 49-50]
- Monitoring is the process of measuring change in ecological character in any wetland over a period of time. [DOC027, pp. 50-52]
- USFWS National Wetlands Inventory provides Status and Trends reports that inform decision-makers on wetland status, changes, and implications to support management. [DOC022]
...
- Joint venture management boards provide strategic oversight and guidance to ensure that Plan goals are being achieved. Boards review feedback from evaluation programs and maintain an updated implementation strategy that reflects current understanding of the joint venture efforts needed to support Plan continental population objectives. Management boards identify the most effective conservation techniques (intensive programs, extensive programs, policy influence) and the relative importance of. [DOC003, pp. 40-42]
...
- Missouri State Wildlife Action Plan describes that freshwater mussels were once abundant but their numbers have greatly diminished due to habitat loss and invasive species. [DOC001, pp. 176-180]
...
- The Missouri Feral Hog Elimination Partnership is made up of agencies and organizations that are committed to total elimination of feral hogs from Missouri’s landscape. In 2020, the partnership established a unified Incident Command System to manage feral hog elimination efforts in the state. [DOC018]
...
- During 2022, the Missouri Feral Hog Elimination Partnership removed a total of 6,289 feral hogs from Missouri’s landscape. [DOC017]
...
- Aquatic Invasive Species in the Chesapeake Bay Watershed document states AIS are introduced by transport aboard or affixed to commercial or recreational vessels including ballast water and biofouling of hulls. [DOC005, pp. 14-15]
- National Aquatic Invasive Species Outreach Workshop Summary Report highlights AIS prevention campaigns targeting recreational boaters with messages like 'Clean Drain Dry' to reduce AIS spread via boating. [DOC010, pp. 2-4]
...
- water storage; storm protection and flood mitigation; shoreline stabilization and erosion control; groundwater recharge and discharge; water purification; retention of nutrients, sediments, and pollutants; and stabilization of local climate conditions. [DOC027, pp. 10-12]
- Missouri State Wildlife Action Plan highlights managing wetlands to enhance processes that transport organic matter, sediments, nutrients, and support wetland-dependent plants and animals. [DOC001, pp. 147-150]
...
- Invasive Carp Strategic Science Plan highlights deterrents such as sound-based and carbon dioxide deterrents to reduce invasive carp movement and prevent new invasions. [DOC012, pp. 22-24]
- Aquatic Invasive Species Research Report notes evaluation of potential control options and technologies at Brandon Road Lock and Dam to prevent upstream interbasin transfer of aquatic nuisance species including invasive carp. [DOC006, pp. 3-4]
