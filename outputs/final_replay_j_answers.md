...
- The Wetlands Protection Program establishes a permit program jointly administered by the U.S. Army Corps of Engineers and EPA to regulate discharges of dredged or fill materials into waters, including wetlands, of the United States. [DOC031, pp. 12-14]
- EPA provides technical support and funding through Wetland Program Development Grants to states, tribes, and local governments to develop or refine wetland programs which protect, manage, and restore wetlands. [DOC023]
- Agency coordination with the U.S. Army Corps of Engineers (USACE), U.S. Fish and Wildlife Service (USFWS), EPA, and MDC through the public notice process of Clean Water Act Section 404 Department of the Army Permit applications and Section 401 Water Quality Certification requests, pre-application, and post-public comment period site visits, and/or partnering meetings. [DOC002, pp. 8-11]
...
- **USFWS National Wetlands Inventory** — Our Status and Trends reports provide estimates of U.S. wetland extent, type, and change specific to different time periods, ranging from the 1700s to 2019. Produced on a decadal basis, these reports inform decision-makers and the public on the status of the nation's wetlands as well as potential causes and implications of wetland change [DOC022]
- **Ramsar Resources** — The Framework for Wetland Inventory, adopted by the COP in Resolution VIII.6 (2002) and the subsequent Framework for processes of detecting, reporting and responding to change in wetland ecological character (Resolution X.16, 2008; both in Handbook 15) provide guidance for designing wetland inventory at multiple scales from site-based to provincial, national and regional [DOC027, pp. 50-52]
- **Missouri Wetland Program Plan** — MDC and other federal, state, and local agencies will systematically work on identified watersheds to incrementally develop an update to the National Wetlands Inventory (NWI) following the development of EDH to increase data handling efficiencies [DOC002, pp. 3-6]
...
- Congress should fund the installation of user-operated decontamination stations at boat launches and access points on federal waterways and highly-used non-federal waterways to allow cleaning, draining, and drying of watercraft. [DOC009, pp. 11-12]
- Federal agencies should work to establish a more coordinated, expedited, and reciprocal process for watercraft inspection, decontamination, and enforcement. [DOC009, pp. 9-11]
...
- The USGS Nonindigenous Aquatic Species Database provides real-time updated occurrence records and distribution maps to help detect nonindigenous aquatic species. [DOC011, pp. 4-6]
- The NAS alert system notifies registered users of new species occurrences at various geographic levels to support early detection and rapid response. [DOC011, pp. 4-6]
- Alerts from the NAS system enable prioritization of monitoring strategies and initiation of management actions including potential eradication. [DOC011, pp. 4-6]
- USACE promotes use of the USGS NAS Alert System and shared databases to improve detection and identification of invasive species and coordinate rapid response. [DOC006, pp. 13-15]
- This online tool creates maps to help assess impacts on aquatic invasive species distributions due to flooding associated with storms. [DOC007, pp. 22-24]
...
- The USGS uses acoustic methods to locate natural aggregations of invasive carp and studies their relation to habitat variables such as water temperature, velocity, and food availability. [DOC012, pp. 17-20]
- Invasive carp can be artificially aggregated by driving them using stimuli they avoid, such as sounds or electricity, and barriers that limit fleeing directions. [DOC012, pp. 17-20]
- Food attractants have been the most successful stimuli to artificially aggregate invasive carp, with pheromone attractants also under investigation. [DOC012, pp. 17-20]
- Removal efforts focus on increasing efficiency of removal gears and harvesting large numbers of carp from natural or artificially aggregated groups. [DOC012, pp. 17-20]
...
- [DOC013, pp. 186-189] **State Wildlife Action Plans Report with State Summaries** — species of Asian carp continue to expand their range in the Sandhill crane/Ohio DNR Wildlife Total number of species Species of Conservation Concern* Threatened/endangered listed species Mussels 81 31 28 Snails 169 0 Crayfi sh 20 1 1 Insects Thousands 22 (terrestrial) 64 Fish 156 40 37 Amphibians 14… [Source](https://www.fishwildlife.org/application/files/6415/1856/1631/StateWildlifeActionPlansReportwithStateSummaries.pdf)

### Answer

The retrieved evidence supports:

- The use of conservation easements through partnership with the Missouri Prairie Foundation and various other partners through the MDC Land Conservation Grant Program to permanently protect sensitive habitats (e.g., grasslands, wetlands, and streams) ) critical for SGCN conservation. [DOC020, pp. 80-82]
...
- Missouri developed Conservation Opportunity Areas through stakeholder meetings and partner collaboration to identify priority conservation opportunities. [DOC013, pp. 140-143]
...
- Around priority caves for federally listed bats, a minimum of 20 acres of appropriate forest/woodland communities is maintained, incorporating topography and watershed considerations into the design, size, and configuration to protect the integrity of the cave system. [DOC001, pp. 128-131]
...
- Missouri Wetland Program Plan states that wetland restoration supports ecological services beneficial to society including flood resiliency and lessening localized flood damage. [DOC002, pp. 15-17]
- Missouri Wetland Program Plan aims to improve and protect water quality of Missouri wetlands in accordance with the Clean Water Act and Water Protection Program recommendations. [DOC002, pp. 15-17]
- Canada's Green Plan identifies wetlands as integral to freshwater systems providing natural flood control and water cleansing. [DOC034, pp. 95-97]
...
- Joint venture management boards provide strategic oversight and guidance to ensure that Plan goals are being achieved, review feedback from evaluation programs, and maintain an updated implementation strategy reflecting current understanding of joint venture efforts needed to support Plan continental population objectives. [DOC003, pp. 40-42]
- Management boards identify the most effective conservation techniques and develop and secure funding for conservation projects. [DOC003, pp. 40-42]
- Joint Venture partners with a range of biological and conservation planning expertise develop science-based conservation plans, implement habitat projects, and undertake applied research. [DOC004, pp. 2-4]
- One of the Plan’s greatest strengths is the ability of its partners to quickly pool and leverage conservation funding from a variety of sources, expanding the Plan’s conservation reach and supporting strategically targeted habitat conservation projects. [DOC004, pp. 1-3]
- The Canadian Habitat Joint Ventures integrate planning, science, governance, partnerships and management to achieve NAWMP goals through a programmatic approach, creating science-based Implementation Plans to address local, regional and continental goals. [DOC014, pp. 8-10]
...
- [DOC016] **MDC Annual Review FY2024** — Assessment and Monitoring Strategic Initiative, which focuses resources on developing tools to assess and monitor the effectiveness of conservation actions within priority geographies. This work is being accomplished by developing achievable and desired future conditions using the Missouri River Hil… [Source](https://mdc.mo.gov/magazines/missouri-conservationist/2025-01/annual-review-fiscal-year-july-1-2023-june-30-2024)
- [DOC013, pp. 86-89] **State Wildlife Action Plans Report with State Summaries** — community or habitat. **An additional 19 species are extinct, or have been eliminated from Illinois. ***Approximate number of regularly occurring species. Including vagrants and accidentals, 432 species have been documented. Wildlife highlights “The Illinois Wildlife Action Plan is not just an inven… [Source](https://www.fishwildlife.org/application/files/6415/1856/1631/StateWildlifeActionPlansReportwithStateSummaries.pdf)
...
- In Action: Restoring Wisconsin’s Oak Savanna Fewer than 500 acres of intact oak savanna remain in Wisconsin. [DOC013, pp. 18-19]
- Education is also important to success; the action plan recommends setting up education demonstration areas to give people a fi rst-hand look at the kinds of active management it will take to restore the savanna, including the rejuvenating force of prescribed fi res. [DOC013, pp. 18-19]
...
- Missouri Wetland Program Plan uses the developed EDH and NWI layers in conjunction with other geospatial data to incrementally run the Beaver Restoration Assessment Tool (BRAT) to assess potential opportunities for beaver as a stream conservation and restoration agent. [DOC002, pp. 6-8]
- Missouri Wetland Program Plan includes USGS and partners continuing to monitor streamflow conditions throughout Missouri that influence wetland hydrology and provide access to real-time hydrologic data. [DOC002, pp. 6-8]
- Missouri Wetland Program Plan involves updating the National Wetlands Inventory (NWI) following development of the Enhanced Digital Hydrography (EDH) dataset to create a new baseline in the distribution and type of wetlands in Missouri. [DOC002, pp. 6-8]
- Missouri Department of Conservation collaborated with partners to create a tool designed to map changes in wetland inundation as part of wetland extent and condition assessment. [DOC018]
...
- Natural resource managers at the federal, state, regional, and tribal levels should seek to engage and elevate trusted voices among recreational user groups, hunters, anglers, the pet industry, aquaculture, and other industries and communities that may serve as vectors for AIS introduction and spread. [DOC009, pp. 12-15]
