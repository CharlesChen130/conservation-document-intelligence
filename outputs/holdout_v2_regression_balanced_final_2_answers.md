...
- MDC uses conservation easements through partnerships with organizations like the Missouri Prairie Foundation to permanently protect sensitive habitats such as grasslands, wetlands, and streams critical for Species of Greatest Conservation Need (SGCN). [DOC020, pp. 80-82]
- Missouri State Wildlife Action Plan notes easement purchases through WRP and ACEP as steps toward restoring forested landscapes in the Bootheel region, indicating easements are used to protect and restore sensitive habitats. [DOC001, pp. 29-30]
...
- Acoustic telemetry is used to locate invasive carp and study their movement and habitat associations to improve removal methods. [DOC012, pp. 17-20]
...
- These new funding opportunities should engage state and tribal leaders and other stakeholders who have on - the-ground experience and understanding of the challenges that AIS present. To facilitate further coordination and prioritization, a single federal research fund for AIS management and control should be established. [DOC009, pp. 7-8]
- DOI bureaus and offices coordinate with federal, state, local, tribal, territorial governments, private landowners, and NGOs to manage invasive species through partnerships and shared resources. [DOC007, pp. 16-22]
- DOI supports regional networks and national groups such as Aquatic Nuisance Species Regional Panels and the Aquatic Nuisance Species Task Force to coordinate invasive species management. [DOC007, pp. 6-9]
