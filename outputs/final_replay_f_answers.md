...
- **Invasive Species Accomplishments Report PDF** — Expanded planning, training, and other guidance to promote prevention practices ... Implemented tools to prevent invasive species introductions, spread, and costly impacts Watercraft inspection and cleaning stations, watercraft decontamination dip tank pilot program, boot brush stations, vehicle wash stations, signage at recreational access points [DOC008, pp. 6-9]
...
- While this course was originally intended for Missouri landowners, contractors who complete the training qualify for “Certified Prescribed Burn Manager” designation, allowing them to comply with House Bill 369, which became effective in August 2021. House Bill 369 is commonly referred to as the Missouri Prescribed Burning Act. [DOC018]
- Prescribed burning is combined with other management tools like grazing to restore and maintain healthy grassland communities in Missouri. [DOC001, pp. 61-63]
- MDC collaborates with nongovernmental organizations and the U.S. Forest Service to provide prescribed burning equipment and training to private landowners through Prescribed Burn Cooperatives and workshops. [DOC016]
...
- Missouri State Wildlife Action Plan states that successful conservation of wetlands should provide connectivity among adjacent uplands and aquatic habitats. [DOC001, pp. 140-145]
- Missouri State Wildlife Action Plan lists removing aquatic organism barriers to improve connectivity as a best management practice for river and stream conservation. [DOC001, pp. 172-174]
- The Missouri Stream Connectivity Partnership (MO SCP) was formed to address removing aquatic organism passage barriers in streams across Missouri. [DOC016]
...
- [DOC013, pp. 188-191] **State Wildlife Action Plans Report with State Summaries** — Each meeting included a participant survey to determine their concerns and interests. Appropriate comments were incorporated in the fi nal draft of the CWCS. 189 Oklahoma snapshot Landscape: Oklahoma has the greatest biological and ecological diversity of any inland state. Its plant com- munities ra… [Source](https://www.fishwildlife.org/application/files/6415/1856/1631/StateWildlifeActionPlansReportwithStateSummaries.pdf)
...
- **Missouri State Wildlife Action Plan** — The Missouri Department of Conservation (the Depart - ment) policy is to maintain a 20-acre buffer of vege - tative cover around any cave or sinkhole opening to protect water quality within caves [DOC001, pp. 126-129]
- **MDC Annual Review FY2021** — Habitat management work assured forest health and provided a broad suite of forest conditions to meet a wide variety of needs for birds and other wildlife. Forest surveys were completed on conservation areas and forest management plans were developed. Using the tree data collected, work was implemented, including the control of invasive plants, harvest of wood products, and planting and thinning of trees [DOC018]
...
- Typically, restoration on easement lands occurs on previously farmed fields where natural water holding exists, with infrastructure and native seed banks used to fully restore wetlands to their original state. [DOC002, pp. 13-15]
- The Missouri Department of Conservation uses conservation easements through partnerships with organizations like the Missouri Prairie Foundation to permanently protect sensitive habitats such as grasslands, wetlands, and streams critical for species of greatest conservation need. [DOC020, pp. 80-82]
...
- The Aquatic Invasive Species Commission Report recommends that federal resource managers expand opportunities for citizen data collection and open-access data systems to support aquatic invasive species detection and aid wildlife managers in conducting early detection and rapid response actions. [DOC009, pp. 12-15]
- The Aquatic Invasive Species Research Report promotes dissemination and utilization of existing databases like EDDMapS and USGS Nonindigenous Aquatic Species Database to improve detection and identification of invasive species and support management actions. [DOC006, pp. 13-15]
...
- The USGS Invasive Carp Strategic Science Plan states that eDNA is used for early detection and surveillance of invasive carp. [DOC012, pp. 17-20]
- Acoustic telemetry is used to locate invasive carp and study their movements and habitat relations to improve removal methods. [DOC012, pp. 17-20]
...
- The EPA Wetlands Program supports wetland protection that stores floodwaters and maintains surface water flow during dry periods. [DOC023]
- Waterfowl habitat restoration and conservation help clean and maintain water supplies, reduce flood risk, and store carbon that would otherwise contribute to climate change. [DOC014, pp. 7-8]
- The North American Waterfowl Management Plan conserves wetlands that help remove bacteria, phosphorous, and nitrates from waters, slow water flows, and reduce potential for damaging floods. [DOC004, pp. 1-3]
- Waterfowl supported wetlands help clean and maintain water supplies, reduce flood risk, and store carbon, providing ecosystem services and supporting biodiversity. [DOC014, pp. 4-7]
- Ducks Unlimited conserves wetlands that provide clean and abundant water, reduce flood risks, and store carbon, supporting sustainability and climate solutions. [DOC021]
...
- Congress should direct federal agencies to define key governmental and nongovernmental partners and designate authority of each partner to coordinate Early Detection and Rapid Response (EDRR) actions. [DOC009, pp. 7-8]
- DOI coordinates at local, regional, national, and international levels through partnerships such as Cooperative Invasive Species/Weed Management Areas, Aquatic Nuisance Species Regional Panels, and the National Invasive Species Council. [DOC007, pp. 6-9]
...
- The live trade vector, including pet, bait, and seafood industries, were further identified as a high priority for focus in AIS pathway management. [DOC005, pp. 20-21]
...
- To protect the cave resources and important bat hibernaculum, in 2012 partners from several organizations constructed a proper, bat-friendly cave gate, which is now the largest standing cave gate in the United States. [DOC001, pp. 130-134]
- Conservation efforts for Ozark cavefish include protecting cave and well openings through gating, capping unused wells, sinkhole buffers, and livestock watering systems to promote sustainable land and water use. [DOC001, pp. 130-134]
- Missouri Department of Conservation and partners maintain appropriate buffers around cave entrances, sinkholes, and springs to protect groundwater quality and promote similar practices on private lands. [DOC001, pp. 29-30]
- Missouri Forest Management Guidelines include best management practices for protecting cave and karst features, including forested watersheds and pesticide use. [DOC001, pp. 29-30]
