...
- Catalog sources: 35
- Raw source artifacts: 35
- Database documents: 35
- Search chunks: 724
- Entity mentions: 6795
- Relations: 987
...
- Catalog contains exactly 35 sources: PASS
...
- Hugging Face publication requires an authenticated account or token.
- A Docker/Hugging Face container smoke test remains required in an environment with Docker available.
