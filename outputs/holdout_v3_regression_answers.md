...
- **Aquatic Invasive Species Research Report** — ERDC is currently developing assays that can be incorporated in hand-held equipment for rapid detection and genetic discrimination between phragmites haplotypes found in North America. Methods to distinguish native from non-native haplotypes and hybrids will inform when and where to implement management [DOC006, pp. 10-12]
- **Invasive Species Accomplishments Report** — A USGS-Great Lakes Science Center scientist counts invasive Phragmites australis stems within a sampling quadrat in Ohio to support landscape-scale adaptive management [DOC007, pp. 16-22]
...
- The Missouri Wetland Program Plan includes monitoring and assessment activities involving multiple agencies to promote scientific knowledge about wetlands. [DOC002, pp. 1-3]
- The Missouri Wetland Program Plan addresses regulation through avoidance, minimization, and mitigation of permanent impacts to wetlands by federal and state agencies. [DOC002, pp. 1-3]
- The Missouri Wetland Program Plan promotes voluntary restoration and protection of wetlands through incentives and assistance provided by private and governmental entities. [DOC002, pp. 1-3]
- The department’s Environmental Services Program (ESP) will collect wetland-specific water quality data to aid in the establishment of water quality standards. [DOC002, pp. 16-20]
- The department participates in webinars hosted by NAWM, NRCS, TNC, USFWS, and other entities for continuing education and training in wetland sciences and issues. [DOC002, pp. 16-20]
...
- Public agencies in Missouri regulate impacts to wetlands to protect habitats and aquatic resource functions through avoidance, minimization, and mitigation of permanent impacts. [DOC002, pp. 1-3]
- Private interests in Missouri provide incentives and assistance for restoring wetlands on their respective properties. [DOC002, pp. 1-3]
- private and public landowners have restored over 150,000 wetland acres through the United States Department of Agriculture’s Wetlands Reserve Easement (WRE) program. [DOC001, pp. 147-150]
- MDC establishes partnerships and cost-share agreements with private organizations and landowners to support wetland restoration and management, including engineering services for wetland construction. [DOC001, pp. 36-37]
- MDC will advocate, provide guidance, and assist where possible for private land-. [DOC002, pp. 6-8]
...
- [DOC013, pp. 218-219] **State Wildlife Action Plans Report with State Summaries** — the main reasons for the bear’s decline. Reservoir construction has fl ooded many miles of former bottomland hardwood habitat. In addition, many bottom- lands forests have been cut and converted to agricultural areas or housing developments. Another species attempting to reestab- lish itself in Texa… [Source](https://www.fishwildlife.org/application/files/6415/1856/1631/StateWildlifeActionPlansReportwithStateSummaries.pdf)
...
- [DOC027, pp. 17-19] **Ramsar Resources** — conservation of listed sites; • to advise the Secretariat of any change in the ecological character of listed sites; • to compensate for any loss of wetland resources if a listed wetland is deleted or restricted; • to use Ramsar criteria for identifying wetlands of international importance; • to use… [Source](https://web.archive.org/web/20240115041420id_/https://www.ramsar.org/sites/default/files/documents/library/manual6-2013-e.pdf)

### Answer

The retrieved evidence supports:

- The National Wetlands Inventory produces and maintains the Wetlands Layer of the National Spatial Data Infrastructure, providing maps and data to guide environmental decisions. [DOC022]
- State Wildlife Action Plans identify species of greatest conservation need and use prior data and plans to guide proactive conservation efforts to avoid species becoming endangered. [DOC013, pp. 12-14]
- In developing the wildlife action plans, state wildlife agencies drew on a sizeable volume of data sources and prior plans for individual species, habitats, and landscapes. Plans consulted by wildlife agencies ranged from:. [DOC013, pp. 12-14]
...
- The Nature Conservancy’s Don’t Move Firewood campaign promotes best practice firewood use and seeks to raise awareness about the firewood pathway both directly, and indirectly by helping partner entities improve their outreach. [DOC010, pp. 2-4]
...
- Among the major accomplishments during 2017 through 2021 were the following: • development of deterrent technologies (Murchy and others, 2017), mass removal methods (Chapman, 2020), and species-specific delivery methods for piscicides ( Poole and others, 2018);. [DOC012, pp. 9-10]
- In 2020 and 2021, we began large-scale evaluations of key deterrent technologies, such as the USGS-developed underwater acoustic deterrent system at Lock and Dam 19 on the Mississippi River near Keokuk, Iowa, and we partnered with the U.S. Fish and Wildlife Service to evaluate a deterrent system that incorporates sound, lights, and a bubble screen at Barkley Lock and Dam near Lake City, Kentucky. [DOC012, pp. 9-10]
- Federal funding supports proven management plans including the use of deterrent technologies like bioacoustic fish fences, gas bubble screens, and electric fences for invasive fish control. [DOC009, pp. 5-7]
...
- NAWMP partners pool and leverage conservation funding from a variety of sources, expanding conservation reach and supporting strategically targeted habitat conservation projects. [DOC004, pp. 2-4]
- NAWMP partners work with government agencies, conservation organizations, and individuals to implement high priority conservation projects using a science-driven approach. [DOC004, pp. 2-4]
...
- **DocumentCloud Wetland Search** — in Delhi in 2010-11 to check the changes in water bodies in last 10 years the status of 44 lakes was ascertained and it was fond that 21 out 44 lakes were gone dry due to rapid urbanization and falling water tables (Singh & Bhat nagar, 2012 [DOC035, pp. 8-10]
...
- In the Horton Bottoms Natural Area, log structures were installed in the man-made ditch to stop complete drainage and restore a more natural hydrology. [DOC001, pp. 152-157]
...
- ERDC scientists are collaborating with the U.S. Geological Survey and academic partners to develop gene-silencing technologies to manage invasive phragmites populations in the Great Lakes. [DOC006, pp. 10-12]
- The research has been successful in designing and testing cell penetrating peptides to deliver small regulatory RNAs into targeted cells of phragmites. [DOC006, pp. 10-12]
- ERDC is developing assays that can be incorporated in hand-held equipment for rapid detection and genetic discrimination between phragmites haplotypes found in North America. [DOC006, pp. 10-12]
- ERDC scientists are developing improved remote sensing-based monitoring capabilities through analysis of high resolution imagery to track and monitor aquatic vegetation including phragmites. [DOC006, pp. 10-12]
...
- The USGS Nonindigenous Aquatic Species Database provides an online reporting system and alert system for new occurrences of nonindigenous aquatic species. [DOC011, pp. 1-2]
- DOI bureaus share data with national invasive species databases including EDDMapS and the USGS Nonindigenous Aquatic Species Database to increase reporting and tracking of invasive species. [DOC007, pp. 22-24]
- EDDMapS is promoted as a partner database to enlist volunteers to increase reporting and tracking of invasive species. [DOC007, pp. 9-12]
- The USGS NAS database serves as a central repository for spatially referenced accounts of introduced aquatic species in the United States, aiding federal and non-federal decision-making. [DOC007, pp. 22-24]
...
- The North American Waterfowl Management Plan pioneered a partnership approach to conservation across public, private, and common lands. [DOC003, pp. 12-14]
- The Plan's implementation involves collaboration among federal, provincial/territorial, state governments, non-governmental organizations, and private and community landowners. [DOC003, pp. 19-21]
- The Plan's implementation is supported by funding mechanisms like the North American Wetlands Conservation Act, which facilitates public-private partnerships and matching funds. [DOC003, pp. 19-21]
