...
- The Missouri Wetland Program Plan involves regulation through avoidance, minimization, and mitigation of permanent impacts to wetlands by federal and state agencies. [DOC002, pp. 1-3]
- The Missouri Wetland Program Plan supports voluntary restoration and protection through incentives and assistance provided by private and governmental entities. [DOC002, pp. 1-3]
...
- Private interests and governmental entities provide incentives and assistance for restoring wetlands on their respective properties. [DOC002, pp. 1-3]
...
- MDC engages in cooperative agreements and cost-share opportunities with private citizens and organizations to implement wetland conservation practices. [DOC001, pp. 36-37]
- Public agencies like MDC collaborate with universities and other partners to conduct research, monitoring, and develop wetland management plans. [DOC002, pp. 6-8]
...
- USFWS National Wetlands Inventory produces and maintains the Wetlands Layer of the National Spatial Data Infrastructure, providing maps and data to guide environmental decisions. [DOC022]
- USFWS National Wetlands Inventory produces decadal Status and Trends reports to inform decision-makers on wetland extent, type, and change. [DOC022]
- State Wildlife Action Plans identify species of greatest conservation need and use diverse data sources to guide proactive conservation planning at the state level. [DOC013, pp. 12-14]
- State Wildlife Action Plans use prior plans, databases, and expert input to identify target species and habitats for conservation actions. [DOC013, pp. 12-14]
- Missouri Wetland Program Plan includes updating the National Wetlands Inventory to improve data handling efficiencies for wetland resource management. [DOC002, pp. 3-6]
...
- One of the Plan’s greatest strengths is the ability of its partners to quickly pool and leverage conservation funding from a variety of sources, expanding conservation reach and supporting targeted habitat conservation projects. [DOC004, pp. 1-3]
...
- The USGS NAS database functions as a clearinghouse for confirmed sightings of nonindigenous aquatic species throughout the United States to support natural resource managers. [DOC011, pp. 1-2]
...
- The USGS NAS database is a web-based, interactive database that is a central repository for spatially referenced accounts of introduced aquatic species in the United States. [DOC007, pp. 22-24]
...
- In the Transformation step, the HABITATS system converts the concentrated algae to useful byproducts by hydrothermal liquefaction, which uses high temperature and pressure to break down the algae, toxins and other organic compounds and converts them into benign products recoverable for biofuels or fertilizer. [DOC006, pp. 7-9]
...
- The Plan's success depends on partnerships that include land managers, private and community landowners, expanding beyond federal intervention to include private, state, provincial, and federal sectors. [DOC003, pp. 19-21]
- What began as an acknowledgement of fiscal realities became the foundation and motivation for an innovative way of doing business: public–private partnerships. [DOC003, pp. 19-21]
