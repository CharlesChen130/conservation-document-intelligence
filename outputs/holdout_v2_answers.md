...
- **National Aquatic Invasive Species Outreach Workshop Summary Report** — Stop Aquatic Hitchhikers! and Clean Drain Dry are two common, nationally recognized campaigns used to target recreational boaters with an AIS prevention message within the United States [DOC010, pp. 2-4]
...
- Missouri State Wildlife Action Plan uses prescribed burns as part of forest and woodland management plans to conserve biodiversity and manage habitat succession stages. [DOC001, pp. 86-88]
- Missouri State Wildlife Action Plan uses prescribed burning combined with grazing and other tools to restore and maintain grassland, prairie, and savanna habitats and to control woody vegetation and invasive species. [DOC001, pp. 61-63]
...
- Removing aquatic organism barriers to improve connectivity is a best management practice for managing and restoring river and stream ecosystems in Missouri. [DOC001, pp. 172-174]
...
- Within ACEP is a Wetland Reserve Easements program (WRE) very similar to the 2008 Farm Bill’s WRP. WRE still offers enrollment of lands into permanent and 30-year easements. [DOC002, pp. 13-15]
...
- The Missouri Department of Conservation (MDC) works with the Natural Resources Conservation Service (NRCS) to implement the Wetland Reserve Easement program and monitors easements annually to ensure compliance and habitat quality. [DOC002, pp. 15-17]
- Conservation easements in Missouri are used to protect sensitive habitats such as wetlands, grasslands, and streams critical for species of greatest conservation need (SGCN). [DOC020, pp. 80-82]
...
- Invasive Carp Strategic Science Plan states that eDNA is used for early detection and surveillance of invasive carp, integrated into streamgage networks using automated sampling and analysis equipment. [DOC012, pp. 17-20]
- Aquatic Invasive Species in the Chesapeake Bay Watershed reports that acoustic tagging and telemetry are used to monitor locations and movement of invasive fish species including carp in waters around Washington DC. [DOC005, pp. 22-23]
- Invasive Carp Strategic Science Plan explains that acoustic methods are used to locate fish and study their relations to habitat variables to understand natural aggregations of bigheaded carp for removal efforts. [DOC012, pp. 17-20]
...
- NAWMP Value Proposition explains that wetlands help remove bacteria, phosphorous, and nitrates from waters, contribute significantly to drinking water quality, and slow water flows to reduce potential for damaging floods. [DOC004, pp. 1-3]
- Ducks Unlimited Conservation Resources states that conserving wetlands provides clean and abundant water, reduces flood risks, protects coastlines, enriches biodiversity, and stores carbon, supporting local communities and providing climate solutions. [DOC021]
...
- To further facilitate coordination and the rapid utilization of EDRR funds, Congress should direct the leading federal agencies t o define all key governmental and nongovernmental partners to be involved in carrying out the response and clearly designate AIS Commission: Improving the Prevention, Eradication, Control and Mitigation of Aquatic Invasive Species Report and Recommendations, February 2023 P a g e | 7 the authority of each partner agency. [DOC009, pp. 7-8]
- Through prevention, early detection, rapid response, eradication, and other coordinated efforts, Interior bureaus and offices—working hand in hand with federal, state, tribal, territorial, and other partners—helped to safeguard the nation’s lands, waters, and wildlife. [DOC007, pp. 16-22]
- Invasive Species Act of 1996 (NISA) amended NANPCA to create a ballast water management program, and subsequent legislation like the Vessel AIS Commission: Improving the Prevention, Eradication, Control and Mitigation of Aquatic Invasive Species Report and Recommendations, February 2023 P a g e | 2 Incidental Discharge Act of 2018 has further regulated vectors for invasive dreissenid (i.e., zebra and quagga) mussels, though more is need ed to regulate spread from smaller commercial and recreational vessels. [DOC009, pp. 2-4]
...
- **Aquatic Invasive Species Research Report** — The WRDA 2018 (Section 1109), further expanded program authorization to include research on improved strategies for early detection, prevention, and management to reduce the occurrence and effects of harmful algal blooms in our Nation’s water resources [DOC006, pp. 4-6]
- **Aquatic Invasive Species Commission Report** — The persistent spread of AIS has led to greater research and spurred innovative approaches to halt their spread and mitigate their harmful impacts. Congress should examine and consider investing in innovation centered around effective interventions against AIS and their invasion pathways. For example, exciting progress is being made with genetic sterilization methods for zebra mussels and the use of eDNA for invasive species detections [DOC009, pp. 7-8]
...
- The National Wetlands Inventory produces and distributes maps and other geospatial data on American wetland and deepwater habitats to support decision makers. [DOC022]
- The Wetlands Mapper provides easy-to-use, map-like views of the nation’s wetland and deepwater resources and allows users to view, query, download and print wetlands data, making it accessible to the public. [DOC022]
- The National Wetlands Inventory spatially integrates wetland data with additional natural resource information and political boundaries to produce a robust decision support tool. [DOC022]
- The National Wetlands Inventory produces Status and Trends reports on U.S. wetland extent, type, and change over time to inform decision-makers and the public. [DOC022]
...
- Aquatic Invasive Species in the Chesapeake Bay Watershed describes trade involving live organisms (live bait, aquarium pets, water gardening, live seafood, biological supplier trade) as a route of aquatic invasive species introduction. [DOC005, pp. 14-15]
- Aquatic Invasive Species Commission Report recommends maintaining and enhancing public engagement strategies to support behavioral change among recreational user groups, hunters, anglers, the pet industry, aquaculture, and other industries that may serve as vectors for AIS introduction and spread. [DOC009, pp. 12-15]
- Aquatic Invasive Species Commission Report recommends expanding USFWS grants to states and tribes to support contract fishing, including per-pound subsidies for invasive carp harvest and other harvest of AIS, to incentivize AIS harvest and reduce population sizes. [DOC009, pp. 12-15]
...
- Missouri State Wildlife Action Plan describes protecting cave and karst water quality by gating cave and well openings and capping unused wells. [DOC001, pp. 130-134]
- Missouri State Wildlife Action Plan describes cooperative projects with landowners including sinkhole buffers and livestock watering systems to protect karst water quality. [DOC001, pp. 130-134]
- Missouri State Wildlife Action Plan states the Department and partners maintain appropriate buffers around cave entrances, sinkholes, and springs to protect groundwater quality. [DOC001, pp. 29-30]
- Missouri State Wildlife Action Plan promotes best management practices for protecting cave/karst features including forested watersheds and pesticide use. [DOC001, pp. 29-30]
...
- Missouri’s Comprehensive Wildlife Strategy promotes management that benefits all wildlife, rather than targeting single species. The strategy identifies 33 Conservation Opportunity Areas in which management strategies will conserve both wildlife populations and the natural systems on which they depend. [DOC013, pp. 139-141]
- Conservation Opportunity Areas in Missouri are used as a framework by the Department of Conservation and partners to focus efforts for species of conservation concern and their habitats. [DOC013, pp. 139-141]
